...
class VCGXT:
    ...
    def LoadText(self, path):
        ...
        table_format = re.compile(r'^\[([0-9a-zA-Z_]{1,7})\]$')
        entry_format = re.compile(r'^([0-9a-zA-Z_]{1,7})=(.*)$')
